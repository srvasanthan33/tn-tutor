...
import { brainwave, tntutor } from "../assets"
		...
		border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${
			...
			<div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
				<a className="block w-[12rem] xl:mr-8" href="#hero">
					<img src={tntutor} color='white' width={190} height={40} />
				</a>
				...
				bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent `}>
					...
					lg:flex-row">
						{navigation.map(item=>(
							<a key={item.id} onClick={handleClick} href={item.url}
							className={`block relative font-code
							test-2xl uppercase text-n-1
